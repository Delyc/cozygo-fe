...
const Promosection = () => {
    return(
        <div className="relative w-full md:w-1/2   rounded-3xl">
          <div className="flex flex-col gap-2.5 p-10 ">
            ...
            <div className="flex flex-col w-4/5 px-10 py-5 mt-20 bg-black/20 rounded-md gap-5">
              ...
              <div className="flex items-center gap-2.5">
                <Image src="/assets/person.jpeg" alt='image' height={10} width={10} className="w-12 rounded h-11" />
