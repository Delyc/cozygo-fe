...
import { Apple, Expand, PlayStore } from "../atoms/svgs";
...
const Footer = () => {
    ...
    return (
        <footer className="flex justify-center bg-blue-950 text-white w-full rounded-lg px-5 py-5 xl:py-20">
            <div className=" flex flex-col md:flex-row  md:flex-wrap justify-between gap-8 w-full xl:gap-20 md:px-8  max-w-[1330px]">
                <div className="flex flex-col gap-2.5 md:gap-5 w-[20rem]">
                    <p className="text-lg font-bold text-white">CozyGo</p>
                    <p className="text-xs text-white leading-6 font-[400]">Lorem ipsum dolor sit amet, consectetur adipiscing
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <p className="text-sm font-semibold text-white">yourmail@domain.com</p>
                    </div>
                    <div className="flex gap-3">
                        <div className="w-8 h-8 bg-blue-900 rounded grid place-content-center">
                ...
                <div className="flex flex-col gap-2.5 md:gap-5 md:w-[10rem]">
                    ...
                    <p className="text-white">Helpful Links</p>
                ...
                <div className="flex flex-col gap-2.5 md:gap-5 w-[20rem] relative  ">
                    ...
                    <p className="text-xs text-white leading-6 font-[400] max-w-[15rem]">Start working with Homeradar that can provide
                        everything you need</p>
                    <div className="flex flex-col gap-2.5">
                        <Button onClick={handleButtonClick} label={"Apple Store"} Icon={<Apple fill={"#172554"} height={""} width={""} stroke={""} strokeWidth={0} />} className={"bg-white flex justify-start px-5 text-blue-900"} />
                        <Button onClick={handleButtonClick} label={"Play Store"} Icon={<PlayStore fill={"#172554"} height={""} width={""} stroke={""} strokeWidth={0} />} className={"bg-white flex justify-start px-5 text-blue-900"} />
                    </div>
