  ...
  return (
    <div className="flex flex-col py-10 xl:py-20 gap-10 w-full max-w-[60rem]">
      ...
      <div className="flex flex-col w-full  px-5 gap-2.5 xl:gap-5 xl:px-20" >
        <p className="uppercase text-sm text-blue-800 font-regular text-center lg:text-start">pricing plan</p>
      ...
      >
        <div className="relative mx-auto w-full  lg:flex px-5 md:px-8 grid md:grid-cols-3 xl:grid-cols-2 place-content-center">
          <motion.div
            ...
            className="shadowAroundFeature featureThreeGradient bg-blue-900/80 disable-mobile-animation relative mx-auto mb-3 w-full min-w-[250px]  md:min-w-[100px] rounded-md px-4 py-8 text-white md:max-w-[250px] lg:my-2 lg:flex lg:w-1/3 lg:max-w-none lg:flex-col lg:px-4 lg:py-10"
          >
