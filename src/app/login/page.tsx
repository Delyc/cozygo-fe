...
const Login: React.FC = () => {
  return (
    <div className='bg-indigo-600 w-screen h-screen flex'>

        <div className='w-1/2 pl-20 pt-20 relative'>
        <h1  className='text-white font-bold text-2xl'>CozyGo</h1>

            <div className='flex flex-col gap-2.5 w-3/4 mt-20 ml-16'>
