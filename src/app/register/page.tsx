...
const Register: React.FC = () => {
    ...
    console.log('imageeee', previewUrl)
            ...
            <div className='flex px-20 py-20 bg-white '>
                ...
                <div className='relative w-1/2 pt-20 pb-20 pl-20 bg-indigo-600 rounded-3xl'>
                    ...
                    <div className='flex flex-col gap-2.5 w-3/4  ml-16'>
                        ...
                        <p className='text-sm text-white/60 leading-5'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Perspiciatis facilis rem ex neque voluptatem voluptate illo, molestiae ducimus alias sapiente id dignissimos itaque. </p>
                ...
                <div className="flex flex-col justify-center w-1/2 bg-white gap-10 px-28">
                    <h1 className='text-3xl leading-8 text-primary_gray'>Login</h1>
                    <div className='flex flex-col gap-4'>
                        ...
                        <ProfilePic onFileSelect={handleCoverImageSelect} />
